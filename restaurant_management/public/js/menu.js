frappe.ready(function () {
    ...
    if (!table_no) {
        frappe.msgprint(__("Table not found in URL. Please scan the QR again."));
        return;
    }
    let style = `
    <style>
    ...
    function open_modal(item) {
        ...
        $("#submitOrder").off("click").on("click", function () {
            ...
            if (!customer_name_val) { frappe.msgprint(__("Enter customer name")); btn.prop('disabled', false).text('Confirm Add'); return; }
